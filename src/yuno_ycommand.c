 ...
 *          Register
 ***************************************************************************/
PUBLIC void register_yuno_ycommand(void)
{
    GCLASS *gclass;
     ...
     */
    gclass = gobj_subclass_gclass(gclass_default_yuno(), GCLASS_YUNO_YCOMMAND_NAME);
    ...
    gobj_register_yuno(ROLE_YCOMMAND, gclass, TRUE);
}
